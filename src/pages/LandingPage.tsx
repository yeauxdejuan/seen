...
export function LandingPage() {
  ...
  return (
    <div className="bg-white dark:bg-black">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center">
          <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            You deserve to be{' '}
            <span className="text-black dark:text-white underline decoration-4 underline-offset-8">Seen</span>
          </h1>
      ...
      <section className="bg-gray-50 dark:bg-gray-950 py-16 border-y-2 border-gray-200 dark:border-gray-800">
      ...
      {/* CTA Section */}
      <section className="bg-black dark:bg-white py-16 border-y-2 border-gray-800 dark:border-gray-200">
      ...
      {/* Prototype Notice */}
      <section className="py-8 bg-gray-100 dark:bg-gray-900 border-t-2 border-gray-300 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-start space-x-3">
            <svg className="w-6 h-6 text-black dark:text-white flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
